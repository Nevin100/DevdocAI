...
export default function SignupPage() {
  ...
  return (
    <main className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-base-100 px-4 py-12 text-base-content selection:bg-primary/25 selection:text-primary sm:px-6">
      ...
      {/* Engineering Grid & Dynamic Radial Glow */}
      ...
      <div className="pointer-events-none absolute -top-36 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-primary/15 blur-[120px]" />
      ...
      <div className="relative w-full max-w-sm sm:max-w-md">
        ...
        <div className="rounded-3xl border border-base-content/10 bg-base-100/80 p-6 shadow-2xl shadow-base-content/5 backdrop-blur-2xl sm:p-8">
          ...
          <button
            ...
            className="group flex w-full items-center justify-center gap-2.5 rounded-2xl border border-base-content/10 bg-base-200/60 px-4 py-2.5 text-xs font-bold text-base-content transition-all hover:border-base-content/25 hover:bg-base-200 active:scale-[0.99] disabled:opacity-60 shadow-sm"
          >
            {githubLoading ? (
                  ...
                  <div className="flex gap-1.5">
                    <div
                      className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                        strengthCount >= 1 ? "bg-warning" : "bg-base-300"
                      }`}
                    />
                    <div
                      className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                        strengthCount >= 2 ? "bg-warning" : "bg-base-300"
                      }`}
                    />
                    <div
                      className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                        strengthCount === 3 ? "bg-success" : "bg-base-300"
                      }`}
                    />
                  </div>
                  <span className="block font-mono text-[10px] text-base-content/50">
          ...
          <p className="mt-4 text-center text-[11px] text-base-content/50 leading-relaxed">
